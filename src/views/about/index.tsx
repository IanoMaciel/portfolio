        ...
        <Container>
            ...
            <AboutContent>
                <p>
                    ...
                    Amazon Web Services, JavaScript moderno, TypeScript, Node.js, React, React
                    Native, a criação de APIs REST e ferramentas de controle de versão e automação.
                    Estou entusiasmado em aplicar meu conhecimento e fazer contribuições valiosas
                ...
                <p>
                    ...
                    . Este projeto é uma iniciativa conjunta entre a UFAM e a Samsung, com ênfase
                    nas áreas de Pesquisa, Desenvolvimento e Inovação (PD&I). Durante esse período,
                    concentrei meus esforços em conduzir estudos no campo da Engenharia de Software,
                    com foco especial na Gerência de Configuração de Software.
                </p>
                ...
                <p>
                    ...
                    principal responsabilidade consiste em conceber novas funcionalidades e conduzir
                ...
                <p>
                    ...
                    modelo de dados e a arquitetura do sistema até o desenvolvimento tanto do
                    backend quanto do frontend.
                </p>
            </AboutContent>
            ...
            <Networks>
                ...
                <ProfilePhoto>
                    <img src={require('../../assets/profilePhoto.png')} alt="Profile Photo" />
                </ProfilePhoto>
            </Networks>
        </Container>
    );
